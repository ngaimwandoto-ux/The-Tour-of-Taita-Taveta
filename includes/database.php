 ...
 *
 * schema.sql is applied on EVERY connection, not just the first —
 * every statement in it is "IF NOT EXISTS", so this is always safe
 * and means new tables added to schema.sql later (like the messaging
 * tables) get created automatically without a manual migration step.
 */
